...
from extra_app.xadmin import BaseAdminPlugin, ListAdminView, CreateAdminView, UpdateAdminView, DeleteAdminView
from extra_app.xadmin import is_related_field2
